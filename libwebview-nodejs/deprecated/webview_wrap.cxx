...
#define SWIGV8_INIT webview_initialize




static SwigV8ReturnValue _wrap_WEBVIEW_HINT_NONE(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
...
static SwigV8ReturnValue _wrap_WEBVIEW_HINT_MIN(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
...
static SwigV8ReturnValue _wrap_WEBVIEW_HINT_MAX(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
...
static SwigV8ReturnValue _wrap_WEBVIEW_HINT_FIXED(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
...
static SwigV8ReturnValue _wrap_webview_create(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_webview_create.");
...
static SwigV8ReturnValue _wrap_webview_destroy(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_webview_destroy.");
...
static SwigV8ReturnValue _wrap_webview_run(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_webview_run.");
...
static SwigV8ReturnValue _wrap_webview_terminate(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_webview_terminate.");
...
static SwigV8ReturnValue _wrap_webview_dispatch(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 3) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_webview_dispatch.");
...
static SwigV8ReturnValue _wrap_webview_get_window(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_webview_get_window.");
...
static SwigV8ReturnValue _wrap_webview_set_title(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_webview_set_title.");
...
static SwigV8ReturnValue _wrap_webview_set_size(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 4) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_webview_set_size.");
...
static SwigV8ReturnValue _wrap_webview_navigate(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_webview_navigate.");
...
static SwigV8ReturnValue _wrap_webview_set_html(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_webview_set_html.");
...
static SwigV8ReturnValue _wrap_webview_init(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_webview_init.");
...
static SwigV8ReturnValue _wrap_webview_eval(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_webview_eval.");
...
static SwigV8ReturnValue _wrap_webview_bind(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 4) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_webview_bind.");
  ...
  arg2 = reinterpret_cast< char * >(buf2);
  {
    int res = SWIG_ConvertFunctionPtr(args[2], (void**)(&arg3), SWIGTYPE_p_f_p_q_const__char_p_q_const__char_p_void__void);
    if (!SWIG_IsOK(res)) {
...
static SwigV8ReturnValue _wrap_webview_unbind(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_webview_unbind.");
...
static SwigV8ReturnValue _wrap_webview_return(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 4) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_webview_return.");
...
#endif
{
  ...
  SWIGV8_AddStaticVariable(exports_obj, "WEBVIEW_HINT_NONE", _wrap_WEBVIEW_HINT_NONE, JS_veto_set_variable, context);
SWIGV8_AddStaticVariable(exports_obj, "WEBVIEW_HINT_MIN", _wrap_WEBVIEW_HINT_MIN, JS_veto_set_variable, context);
SWIGV8_AddStaticVariable(exports_obj, "WEBVIEW_HINT_MAX", _wrap_WEBVIEW_HINT_MAX, JS_veto_set_variable, context);
SWIGV8_AddStaticVariable(exports_obj, "WEBVIEW_HINT_FIXED", _wrap_WEBVIEW_HINT_FIXED, JS_veto_set_variable, context);
  ...
  SWIGV8_AddStaticFunction(exports_obj, "webview_create", _wrap_webview_create, context);
SWIGV8_AddStaticFunction(exports_obj, "webview_destroy", _wrap_webview_destroy, context);
SWIGV8_AddStaticFunction(exports_obj, "webview_run", _wrap_webview_run, context);
SWIGV8_AddStaticFunction(exports_obj, "webview_terminate", _wrap_webview_terminate, context);
SWIGV8_AddStaticFunction(exports_obj, "webview_dispatch", _wrap_webview_dispatch, context);
SWIGV8_AddStaticFunction(exports_obj, "webview_get_window", _wrap_webview_get_window, context);
SWIGV8_AddStaticFunction(exports_obj, "webview_set_title", _wrap_webview_set_title, context);
SWIGV8_AddStaticFunction(exports_obj, "webview_set_size", _wrap_webview_set_size, context);
SWIGV8_AddStaticFunction(exports_obj, "webview_navigate", _wrap_webview_navigate, context);
SWIGV8_AddStaticFunction(exports_obj, "webview_set_html", _wrap_webview_set_html, context);
SWIGV8_AddStaticFunction(exports_obj, "webview_init", _wrap_webview_init, context);
SWIGV8_AddStaticFunction(exports_obj, "webview_eval", _wrap_webview_eval, context);
SWIGV8_AddStaticFunction(exports_obj, "webview_bind", _wrap_webview_bind, context);
SWIGV8_AddStaticFunction(exports_obj, "webview_unbind", _wrap_webview_unbind, context);
SWIGV8_AddStaticFunction(exports_obj, "webview_return", _wrap_webview_return, context);
...
NODE_MODULE(webview, webview_initialize)
#else
NODE_MODULE_CONTEXT_AWARE(webview, webview_initialize)
#endif
#endif
